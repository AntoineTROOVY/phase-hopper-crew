...
import { Play, Pause, Volume2, ChevronDown, Headphones, ExternalLink, ChevronUp } from 'lucide-react';
...
const VoiceOverPreview = ({
  ...
  const openFirstAudioFile = (e: React.MouseEvent) => {
    e.stopPropagation();
    ...
    <div className="border rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">Voice-Over Preview</span>
